...
win["bg"] = "#fafafa"
win.title("Кредитный калькулятор")
...
credit_label = Label(input_frame, text="Сумма кредита", bg=win["bg"])
...
table.heading("payment", text="Выплата", anchor=CENTER)
table.heading("mod", text="Остаток", anchor=CENTER)
